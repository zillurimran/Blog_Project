                ...
                <div class="col-md-9 post-content" data-aos="fade-up">
                    ...
                    <div class="single-post">
                        ...
                        <div class="my-4">
                         ...
                         <p>{{substr($blog->description,12)}}</p>
                    ...
                    <div class="row justify-content-center mt-5">
                     ...
                     @else
                        <h3 class="text-success mt-3">Please <a href="{{route('user.login')}}" class="text-decoration-underline text-danger">Login</a> to continue</h3>
                @endif
                    <!-- End Comments Form -->
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="pills-popular" role="tabpanel" aria-labelledby="pills-popular-tab">
                                <div class="post-entry-1 border-bottom">
                                    <div class="post-meta"><span class="date">{{$categoryWiseBlog->cat_name}}</span> <span class="mx-1">&bullet;</span> <span>{{$categoryWiseBlog->date}}</span></div>
                                    <h2 class="mb-2"><a href={{route('blog',['slug'=>$categoryWiseBlog->slug])}}>{{$categoryWiseBlog->title}}</a></h2>
